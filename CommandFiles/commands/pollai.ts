...
export const style: CommandStyle = {
  title: "🌸 Christus • Pollinations AI",
  titleFont: "bold",
  contentFont: "fancy",
};
...
const API_URL = "https://rapido.zetsu.xyz/api/pollinations";
...
export const entry = defineEntry(
  async ({ input, output, args, langParser }) => {
    ...
    try {
      ...
      const filePath = path.join(CACHE_DIR, `pollinations_${Date.now()}.png`);
      ...
      console.error("Pollinations Command Error:", err.message || err);
      await output.unsend(waitMsg.messageID);
